package com.project.tgs_marker_15421010_ricky;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.invalidate();
        startMarker3.setIcon(getResources().getDrawable(R.drawable.ubl));
        ...
        map.invalidate();
        startMarker4.setIcon(getResources().getDrawable(R.drawable.mbkk));
        startMarker4.setTitle("Mall Boemi Kedaton");


        GeoPoint startPoint5 = new GeoPoint(-5.351598,105.260808);
